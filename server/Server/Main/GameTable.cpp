...
VOID TableInit::InitPetDomesticationMoney( )
{
    ...
    if( iTableCount > PET_LEVEL_NUM){ Assert(iTableCount <= PET_LEVEL_NUM);iTableCount = PET_LEVEL_NUM; }
...
{// 初始化技能分配表
    ...
    if( iTableCount > PET_MAX_NUM){ Assert(iTableCount <= PET_MAX_NUM);iTableCount = PET_MAX_NUM; }
...
{// 初始化技能索引表，此表主要是为了以后维护方便！
    ...
    if( iTableCount > PET_SKILL_NUM){ Assert(iTableCount <= PET_SKILL_NUM);iTableCount = PET_SKILL_NUM; }
    memset(g_PetSkillIndexTbl, 0, sizeof(_PET_SKILLINDEX_TBL) * PET_SKILL_NUM);

    for (INT i = 0; i < iTableCount; i++)
    {
        Assert( i < PET_SKILL_NUM );
...
VOID TableInit::InitPetApperceiveSkillTable( )
{
    ...
    if( iTableCount > PET_APPERCEIVESKILLRATE_NUM){ Assert(iTableCount <= PET_APPERCEIVESKILLRATE_NUM);iTableCount = PET_APPERCEIVESKILLRATE_NUM; }
...
VOID    TableInit::InitCitySceneTable()
{
    ...
    for(INT i = 0,k =0; i<iTableCount; i++)
    {
        ...
        strncpy( g_CitySceneTbl.m_Table[i].m_szSceneFile, ThirdFile.Search_Posistion(i,9)->pString, sizeof( g_CitySceneTbl.m_Table[i].m_szSceneFile ) - 1 ); //LM修改
    }
...
__ENTER_FUNCTION
    ...
    INT iTableCount = 1;//ThirdFile.GetRecordsNum();//LM修改
    ...
    for (INT i = 0; i < iTableCount; ++i)
    {
        g_MissionDataTable.m_MissionData[i].nMissionID            = 490;//ThirdFile.Search_Posistion(i, DataIdx_MissionID)->iValue;
        g_MissionDataTable.m_MissionData[i].nMissionClass        = 17;//ThirdFile.Search_Posistion(i, DataIdx_MissionClass)->iValue;
        g_MissionDataTable.m_MissionData[i].nMissionSubClass    = 0;//ThirdFile.Search_Posistion(i, DataIdx_MissionSubClass)->iValue;
        g_MissionDataTable.m_MissionData[i].nMissionType        = 0;//ThirdFile.Search_Posistion(i, DataIdx_MissionType)->iValue;
        g_MissionDataTable.m_MissionData[i].nMissionLevel        = 0;//ThirdFile.Search_Posistion(i, DataIdx_MissionLevel)->iValue;
        g_MissionDataTable.m_MissionData[i].nLevel                = 0;//ThirdFile.Search_Posistion(i, DataIdx_Level)->iValue;
        g_MissionDataTable.m_MissionData[i].nMaxLeve            = 0;//ThirdFile.Search_Posistion(i, DataIdx_MaxLeve)->iValue;
        g_MissionDataTable.m_MissionData[i].nCamp                = 0;//ThirdFile.Search_Posistion(i, DataIdx_Camp)->iValue;
        g_MissionDataTable.m_MissionData[i].nIdentity            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Identity)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem1ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item1ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem1Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item1Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem2ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item2ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem2Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item2Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem3ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item3ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem3Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item3Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem4ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item4ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem4Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item4Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem5ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item5ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem5Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item5Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem6ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item6ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem6Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item6Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem7ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item7ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nItem7Num            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Item7Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster1ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster1ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster1Num        = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster1Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster2ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster2ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster2Num        = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster2Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster3ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster3ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster3Num        = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster3Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster4ID            = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster4ID)->iValue;
        g_MissionDataTable.m_MissionData[i].nMonster4Num        = 0;//ThirdFile.Search_Posistion(i, DataIdx_Monster4Num)->iValue;
        g_MissionDataTable.m_MissionData[i].nMoney1                = 0;//ThirdFile.Search_Posistion(i, DataIdx_Money1)->iValue;
        g_MissionDataTable.m_MissionData[i].nMoney2                = 0;//ThirdFile.Search_Posistion(i, DataIdx_Money2)->iValue;
        g_MissionDataTable.m_MissionData[i].nMenPai                = 0;//ThirdFile.Search_Posistion(i, DataIdx_MenPai)->iValue;
        g_MissionDataTable.m_MissionData[i].nGuildLevel            = 0;//ThirdFile.Search_Posistion(i, DataIdx_GuildLevel)->iValue;
        g_MissionDataTable.m_MissionData[i].nMissionKind        = 0;//ThirdFile.Search_Posistion(i, DataIdx_MissionKind)->iValue;
        g_MissionDataTable.m_MissionData[i].nTotalTimes            = 0;//ThirdFile.Search_Posistion(i, DataIdx_TotalTimes)->iValue;
        g_MissionDataTable.m_MissionData[i].nDayTimes            = 0;//ThirdFile.Search_Posistion(i, DataIdx_DayTimes)->iValue;
        g_MissionDataTable.m_MissionData[i].nTimeDist            = 0;//ThirdFile.Search_Posistion(i, DataIdx_TimeDist)->iValue;
        g_MissionDataTable.m_MissionData[i].nMaxCycle            = 0;//ThirdFile.Search_Posistion(i, DataIdx_MaxCycle)->iValue;
        g_MissionDataTable.m_MissionData[i].nPositionTag        = 0;//ThirdFile.Search_Posistion(i, DataIdx_PositionTag)->iValue;
        g_MissionDataTable.m_MissionData[i].nPreMission            = 0;//ThirdFile.Search_Posistion(i, DataIdx_PreMission)->iValue;
        g_MissionDataTable.m_MissionData[i].nAftMission            = 0;//ThirdFile.Search_Posistion(i, DataIdx_AftMission)->iValue;
    }
...
__ENTER_FUNCTION
    ...
    INT iTableColumn = 22;////ThirdFile.GetFieldsNum();//LM修改
    ...
    for (INT i = 0; i < iTableCount; ++i)
    {
        g_MissionRewardTable.m_MissionReward[i].nRewardID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_RewardID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nMoney                = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Money)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem1ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item1ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem1Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item1Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem2ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item2ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem2Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item2Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem3ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item3ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem3Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item3Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem4ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item4ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem4Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item4Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem5ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item5ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem5Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item5Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem6ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item6ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nItem6Num            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Item6Num)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nExp                = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Exp)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nLevel                = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Level)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nGuildExp1            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_GuildExp1)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nGuildExp2            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_GuildExp2)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nGuildExp3            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_GuildExp3)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nBuff1ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Buff1ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nBuff2ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Buff2ID)->iValue;
        g_MissionRewardTable.m_MissionReward[i].nBuff3ID            = 0;//ThirdFile.Search_Posistion(i, RewardIdx_Buff3ID)->iValue;
    }
...
__ENTER_FUNCTION
    ...
    INT iTableCount = 1;//ThirdFile.GetRecordsNum();
    INT iTableColumn = 11;//ThirdFile.GetFieldsNum();//LM修改
    ...
    for (INT i = 0; i < iTableCount; ++i)
    {
        g_MissionPunishTable.m_MissionPunish[i].nPunishID        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_PunishID)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nMoney            = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Money)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem1ID        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item1ID)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem1Num        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item1Num)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem2ID        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item2ID)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem2Num        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item2Num)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem3ID        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item3ID)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nItem3Num        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Item3Num)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nExp            = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Exp)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nLevel            = 0;//ThirdFile.Search_Posistion(i, PunishIdx_Level)->iValue;
        g_MissionPunishTable.m_MissionPunish[i].nMissionTag        = 0;//ThirdFile.Search_Posistion(i, PunishIdx_MissionTag)->iValue;
    }
