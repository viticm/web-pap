 ...
 * @date 2013-8-27 13:43:55
 * @uses the scene module for server
 */
/////////////////////////////////////////////////////////////////////////////////
//文件名：Scene.h
...
public :
    ...
    //N为配置好的信息
    BOOL            BroadCast( Packet* pPacket, Obj_Character* pOwnCharacter, BOOL bSendMe = FALSE ) ;

    //向ZoneID所在区域为中心广播一个消息
    //范围为ZoneID所在区域以及周围N圈Zone
    //N为配置好的信息
    BOOL            BroadCast( Packet* pPacket, ZoneID_t zoneID ) ;
    ...
    BOOL            BroadCast_Chat( Packet* pPacket, ZoneID_t zoneID ) ;
...
public :
    ...
    CHAR*              FormatMissionString( const CHAR* strIn, 
                                            CHAR* strOut, 
