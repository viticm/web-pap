...
-- ----------------------------
--  Procedure definition for `cacultotal`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `create_newchar`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `delete_char_new`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `fetch_guid`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `fetch_savetime`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `get_50level_list`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `get_50money_list`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `get_50xinfa_list`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_charextra`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cityinfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cityinfo_bld`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cityinfo_ext`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cityinfo_new`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cshop`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_cshopitem`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_findfriendad`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_general_set`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_global`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_guild_user`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_guildinfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_guildinfo_new`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_iteminfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_league`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_league_apply`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_league_usr`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_mailinfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_petiteminfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo_new`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo_stall`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo_stall_buy`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo_stall_itm`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `save_shopinfo_stall_pet`
-- ----------------------------
